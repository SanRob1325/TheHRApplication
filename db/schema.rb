...
ActiveRecord::Schema[8.0].define(version: 2024_12_16_125604) do
  ...
  create_table "perfomance_reviews", force: :cascade do |t|
    t.integer "employee_id", null: false
    t.string "reviewer"
    t.integer "rating"
    t.text "feedback"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["employee_id"], name: "index_perfomance_reviews_on_employee_id"
  end
  ...
  add_foreign_key "perfomance_reviews", "employees"
